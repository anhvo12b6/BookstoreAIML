...
namespace MLModel1_ConsoleApp1
{
    public partial class MLModel1
    {
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"FavoriteCategory")]
            public float[] FavoriteCategory { get; set; }

            [ColumnName(@"WillBuy")]
            public uint WillBuy { get; set; }
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("WillBuy");
            if (labelColumn == null)
            {
                throw new Exception("WillBuy column not found. Make sure the name searched for matches the name in the schema.");
            }
